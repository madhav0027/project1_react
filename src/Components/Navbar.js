    ...
    return (
        <div className='container-fluid' id='container-fluid'>
                ...
                {isopen &&<div className='nav-components'>
                    <ul className='ul-nav'>
                        <li><a href='project1_react/#/dashboard'>Home</a></li>
                        {/* <li><a href='/samples'>Samples</a></li> */}
                        <li><a href='project1_react/#/packs'>Packs</a></li>
                        <li><a href='project1_react/#/about'>About</a></li>
                        <li>
                ...
                <div className='profile-dialog-overlay'>
                    <div className='profile-dialog'>
                        <div className='dialog-profile'>
                            ...
                            <Link to={'project1_react/#/packupload'}>
            ...
            {isauthenticated ? <div className="menu">
                ...
                :
                    isopen &&<div className="menu-login">
                        <Link to={'project1_react/#/login'}>
                            <button className="menu-item">Login</button>
                        </Link>
                        <Link to={'project1_react/#/register'}>
